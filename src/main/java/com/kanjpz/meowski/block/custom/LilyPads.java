...
public class LilyPads extends BushBlock {
    public static final MapCodec<LilyPads> CODEC = simpleCodec(LilyPads::new);
    ...
    public MapCodec<LilyPads> codec() {
        return CODEC;
    }

    public LilyPads(BlockBehaviour.Properties properties) {
        super(properties);
    }
